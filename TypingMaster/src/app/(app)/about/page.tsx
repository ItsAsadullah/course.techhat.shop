...
import {
  Info, ExternalLink, Globe, Mail, Keyboard, GraduationCap,
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 py-2">
      ...
      <div className="space-y-2">
        ...
        {[
          { icon: <ExternalLink className="w-4 h-4" />, label: "GitHub", href: "https://github.com/TechHatBD", desc: t("Source code", "সোর্স কোড") },
