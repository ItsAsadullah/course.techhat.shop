import { Y as g, X as x, Q as k, h as m } from "./index-3GFABpq9.js";
import { T as b } from "./TransitionGroupContext-CJT0Ny2r.js";
const N = { disabled: !1 };
var O = function (l) {
    return l.scrollTop;
  },
  ...
  o = (function (v) {
    ...
    function l(r, e) {
      var t;
      t = v.call(this, r, e) || this;
      var n = e,
        i = n && !n.isMounting ? r.enter : r.appear,
        a;
      return (
        (t.appearStatus = null),
        r.in
          ? i
            ? ((a = u), (t.appearStatus = p))
            : (a = c)
    ...
    l.getDerivedStateFromProps = function (e, t) {
      var n = e.in;
      return n && t.status === E ? { status: u } : null;
    };
    var s = l.prototype;
    return (
      ...
      (s.performEnter = function (e) {
        var t = this,
          ...
          a = this.props.nodeRef ? [i] : [x.findDOMNode(this), i],
          f = a[0],
          h = a[1],
          S = this.getTimeouts(),
      ...
      (s.performExit = function () {
        var e = this,
          t = this.props.exit,
          n = this.getTimeouts(),
          i = this.props.nodeRef ? void 0 : x.findDOMNode(this);
        if (!t || N.disabled) {
      ...
      (s.onTransitionEnd = function (e, t) {
        ...
        var n = this.props.nodeRef
            ? this.props.nodeRef.current
            : x.findDOMNode(this),
          i = e == null && !this.props.addEndListener;
        if (!n || i) {
      ...
      (s.render = function () {
        ...
        return m.createElement(
          ...
          typeof n == "function"
            ? n(e, i)
            : m.cloneElement(m.Children.only(n), i)
        );
      }),
      l
    );
...
o.ENTERED = c;
o.EXITING = T;
export { p as E, o as T, c as a, O as f };
