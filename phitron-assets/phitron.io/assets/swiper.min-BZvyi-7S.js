import { h as O, r as L } from "./index-3GFABpq9.js";
function oe(e) {
  return (
    e !== null &&
    typeof e == "object" &&
...
function ae(e = {}, i = {}) {
  Object.keys(i).forEach((t) => {
    typeof e[t] > "u"
      ? (e[t] = i[t])
      : oe(i[t]) && oe(e[t]) && Object.keys(i[t]).length > 0 && ae(e[t], i[t]);
  });
}
const he = {
  body: {},
...
class D extends Array {
  constructor(i) {
    typeof i == "number" ? super(i) : (super(...(i || [])), Ie(this));
  }
}
function X(e = []) {
  const i = [];
  return (
    e.forEach((t) => {
      Array.isArray(t) ? i.push(...X(t)) : i.push(t);
    }),
    i
  );
}
...
function Ne(...e) {
  const i = X(e.map((t) => t.split(" ")));
  return (
    me(this, (t) => i.filter((s) => t.classList.contains(s)).length > 0)
      .length > 0
  );
}
function Ge(e, i) {
  ...
  for (let t = 0; t < this.length; t += 1)
    ...
    else for (const s in e) (this[t][s] = e[s]), this[t].setAttribute(s, e[s]);
  return this;
}
function Be(e) {
...
function je(...e) {
  ...
  function r(o) {
    ...
    if ((u.indexOf(o) < 0 && u.unshift(o), m(c).is(t))) s.apply(c, u);
    else {
      const f = m(c).parents();
      for (let h = 0; h < f.length; h += 1) m(f[h]).is(t) && s.apply(f[h], u);
    }
  }
  function a(o) {
    const c = o && o.target ? o.target.dom7EventData || [] : [];
    c.indexOf(o) < 0 && c.unshift(o), s.apply(this, c);
  }
  const d = i.split(" ");
  let l;
    ...
    if (t)
      for (l = 0; l < d.length; l += 1) {
        ...
        c.dom7LiveListeners || (c.dom7LiveListeners = {}),
          ...
          c.dom7LiveListeners[u].push({ listener: s, proxyListener: r }),
      ...
      for (l = 0; l < d.length; l += 1) {
        ...
        c.dom7Listeners || (c.dom7Listeners = {}),
          ...
          c.dom7Listeners[u].push({ listener: s, proxyListener: a }),
          c.addEventListener(u, a, n);
      }
  }
  return this;
}
  ...
  for (let a = 0; a < r.length; a += 1) {
    ...
    for (let l = 0; l < this.length; l += 1) {
      ...
      if (
        (!t && o.dom7Listeners
          ? (c = o.dom7Listeners[d])
          : t && o.dom7LiveListeners && (c = o.dom7LiveListeners[d]),
        c && c.length)
      )
        for (let u = c.length - 1; u >= 0; u -= 1) {
          ...
          (s &&
            ...
            ? (o.removeEventListener(d, f.proxyListener, n), c.splice(u, 1))
            : s ||
              (o.removeEventListener(d, f.proxyListener, n), c.splice(u, 1));
        }
    }
  ...
  for (let n = 0; n < t.length; n += 1) {
    ...
    for (let a = 0; a < this.length; a += 1) {
      ...
      if (i.CustomEvent) {
        ...
        (d.dom7EventData = e.filter((o, c) => c > 0)),
          d.dispatchEvent(l),
          (d.dom7EventData = []),
...
function tt(e) {
  ...
  if (typeof e == "string") {
    ...
    for (n = m(e), r = 0; r < n.length; r += 1) if (n[r] === s) return !0;
    return !1;
  }
  if (e === t) return s === t;
  if (e === i) return s === i;
  ...
  for (let s = 0; s < e.length; s += 1) {
    ...
    for (let n = 0; n < this.length; n += 1)
      if (typeof i == "string") {
        ...
        for (let r = 0; r < i.length; r += 1) this[n].appendChild(i[r]);
...
function at(e) {
  ...
  for (; t.nextElementSibling; ) {
    ...
    e ? m(s).is(e) && i.push(s) : i.push(s), (t = s);
  }
  return m(i);
}
function ot(e) {
  if (this.length > 0) {
    const i = this[0];
    return e
      ? i.previousElementSibling && m(i.previousElementSibling).is(e)
        ? m([i.previousElementSibling])
        : m([])
...
function ct(e) {
  ...
  for (let t = 0; t < this.length; t += 1)
    this[t].parentNode !== null &&
      (e
        ? m(this[t].parentNode).is(e) && i.push(this[t].parentNode)
        : i.push(this[t].parentNode));
  return m(i);
}
function ft(e) {
  const i = [];
  for (let t = 0; t < this.length; t += 1) {
    ...
    for (; s; ) e ? m(s).is(e) && i.push(s) : i.push(s), (s = s.parentNode);
  }
  return m(i);
}
function ut(e) {
  let i = this;
  return typeof e > "u" ? m([]) : (i.is(e) || (i = i.parents(e).eq(0)), i);
}
function pt(e) {
  const i = [];
  for (let t = 0; t < this.length; t += 1) {
...
function ht(e) {
  ...
  for (let t = 0; t < this.length; t += 1) {
    ...
    for (let n = 0; n < s.length; n += 1) (!e || m(s[n]).is(e)) && i.push(s[n]);
  }
  return m(i);
}
function mt() {
...
Object.keys(de).forEach((e) => {
  Object.defineProperty(m.fn, e, { value: de[e], writable: !0 });
});
function gt(e) {
  const i = e;
  Object.keys(i).forEach((t) => {
...
function _(...e) {
  ...
  for (let s = 1; s < e.length; s += 1) {
    const n = e[s];
    if (n != null && !St(n)) {
      const r = Object.keys(Object(n)).filter((a) => t.indexOf(a) < 0);
        ...
        o !== void 0 &&
          ...
          (K(i[l]) && K(n[l])
            ? n[l].__swiper__
              ...
              : _(i[l], n[l])
            : !K(i[l]) && K(n[l])
            ? ((i[l] = {}), n[l].__swiper__ ? (i[l] = n[l]) : _(i[l], n[l]))
            : (i[l] = n[l]));
      }
    }
  }
...
function ge({ swiper: e, targetPosition: i, side: t }) {
  const s = P(),
    n = -e.translate;
  let r = null,
    a;
  ...
  const l = i > n ? "next" : "prev",
    o = (u, f) => (l === "next" && u >= f) || (l === "prev" && u <= f),
    c = () => {
      (a = new Date().getTime()), r === null && (r = a);
      const u = Math.max(Math.min((a - r) / d, 1), 0),
        f = 0.5 - Math.cos(u * Math.PI) / 2;
      let h = n + f * (i - n);
      if ((o(h, i) && (h = i), e.wrapperEl.scrollTo({ [t]: h }), o(h, i))) {
        (e.wrapperEl.style.overflow = "hidden"),
          (e.wrapperEl.style.scrollSnapType = ""),
          setTimeout(() => {
            (e.wrapperEl.style.overflow = ""), e.wrapperEl.scrollTo({ [t]: h });
          }),
          s.cancelAnimationFrame(e.cssModeFrameID);
        return;
      }
...
function bt({ userAgent: e } = {}) {
  ...
  const c = n.match(/(iPod)(.*OS\s([\d_]+))?/),
    u = !o && n.match(/(iPhone\sOS|iOS)\s([\d_]+)/),
    f = s === "Win32";
  let h = s === "MacIntel";
  const v = [
    "1024x1366",
  ...
  return (
    ...
    (o || u || c) && ((r.os = "ios"), (r.ios = !0)),
    r
  );
}
function Et(e = {}) {
  return ee || (ee = bt(e)), ee;
}
let te;
function xt() {
  const e = P();
...
function yt({ swiper: e, on: i, emit: t }) {
  const s = P();
  let n = null,
    r = null;
  const a = () => {
      ...
      !e ||
        ...
        ((n = new ResizeObserver((c) => {
          r = s.requestAnimationFrame(() => {
            ...
            let h = u,
              v = f;
            c.forEach(({ contentBoxSize: w, contentRect: g, target: p }) => {
              (p && p !== e.el) ||
                ((h = g ? g.width : (w[0] || w).inlineSize),
                (v = g ? g.height : (w[0] || w).blockSize));
            }),
              (h !== u || v !== f) && a();
          });
        })),
...
function Mt({ swiper: e, extendParams: i, on: t, emit: s }) {
  const n = [],
    r = P(),
    a = (o, c = {}) => {
    ...
    d = () => {
      if (e.params.observer) {
        if (e.params.observeParents) {
          ...
          for (let c = 0; c < o.length; c += 1) a(o[c]);
        }
...
const Lt = {
  ...
  once(e, i, t) {
    ...
    if (!s.eventsListeners || s.destroyed || typeof i != "function") return s;
    function n(...r) {
      s.off(e, n), n.__emitterProxy && delete n.__emitterProxy, i.apply(s, r);
    }
  ...
  emit(...e) {
    ...
    return (
      typeof e[0] == "string" || Array.isArray(e[0])
        ? ((t = e[0]), (s = e.slice(1, e.length)), (n = i))
        : ((t = e[0].events), (s = e[0].data), (n = e[0].context || i)),
      s.unshift(n),
...
function Ot() {
  ...
  typeof e.params.width < "u" && e.params.width !== null
    ...
    typeof e.params.height < "u" && e.params.height !== null
      ? (t = e.params.height)
      : (t = s[0].clientHeight),
    !((i === 0 && e.isHorizontal()) || (t === 0 && e.isVertical())) &&
      ((i =
        i -
...
function Pt() {
  ...
  function t(x, E) {
    return parseFloat(x.getPropertyValue(i(E)) || 0);
  }
  const s = e.params,
  ...
  typeof T == "string" &&
    ...
    s.centeredSlides &&
      s.cssMode &&
      (U(e.wrapperEl, "--swiper-centered-offset-before", ""),
      U(e.wrapperEl, "--swiper-centered-offset-after", ""));
  const G = s.grid && s.grid.rows > 1 && e.grid;
  G && e.grid.initSlides(u);
  let M;
  const H =
  ...
  for (let x = 0; x < u; x += 1) {
    M = 0;
    const E = c.eq(x);
    if ((G && e.grid.updateSlide(x, E, u, i), E.css("display") !== "none")) {
      if (s.slidesPerView === "auto") {
        H && (c[x].style[i("width")] = "");
        const y = getComputedStyle(E[0]),
          A = E[0].style.transform,
          V = E[0].style.webkitTransform;
        if (
          (A && (E[0].style.transform = "none"),
          V && (E[0].style.webkitTransform = "none"),
          s.roundLengths)
        )
          M = e.isHorizontal() ? E.outerWidth(!0) : E.outerHeight(!0);
        else {
          const F = t(y, "width"),
            Z = t(y, "padding-left"),
            J = t(y, "padding-right"),
            Y = t(y, "margin-left"),
            $ = t(y, "margin-right"),
            R = y.getPropertyValue("box-sizing");
          if (R && R === "border-box") M = F + Y + $;
          else {
            const { clientWidth: Oe, offsetWidth: Pe } = E[0];
            M = F + Z + J + Y + $ + (Pe - Oe);
          }
        }
        A && (E[0].style.transform = A),
          V && (E[0].style.webkitTransform = V),
          s.roundLengths && (M = Math.floor(M));
      } else
        (M = (r - (s.slidesPerView - 1) * T) / s.slidesPerView),
          s.roundLengths && (M = Math.floor(M)),
          c[x] && (c[x].style[i("width")] = `${M}px`);
      c[x] && (c[x].swiperSlideSize = M),
        v.push(M),
        s.centeredSlides
          ? ((C = C + M / 2 + b / 2 + T),
            b === 0 && x !== 0 && (C = C - r / 2 - T),
  ...
  if (
    ...
    s.setWrapperSize &&
      n.css({ [i("width")]: `${e.virtualSize + s.spaceBetween}px` }),
    G && e.grid.updateWrapperSize(M, f, i),
    !s.centeredSlides)
  ) {
    const x = [];
  ...
  if ((f.length === 0 && (f = [0]), s.spaceBetween !== 0)) {
    const x = e.isHorizontal() && a ? "marginLeft" : i("marginRight");
    c.filter((E, y) => (s.cssMode ? y !== c.length - 1 : !0)).css({
      [x]: `${T}px`,
    });
  }
  if (s.centeredSlides && s.centeredSlidesBounds) {
    let x = 0;
    v.forEach((y) => {
      x += y + (s.spaceBetween ? s.spaceBetween : 0);
    }),
      (x -= s.spaceBetween);
    const E = x - r;
    f = f.map((y) => (y < 0 ? -w : y > E ? E + g : y));
  }
  ...
  if (
    ...
    U(e.wrapperEl, "--swiper-centered-offset-before", `${-f[0]}px`),
      U(
        e.wrapperEl,
    ...
    const x = -e.snapGrid[0],
      E = -e.slidesGrid[0];
    (e.snapGrid = e.snapGrid.map((y) => y + x)),
      (e.slidesGrid = e.slidesGrid.map((y) => y + E));
  }
  if (
...
function It() {
  ...
  for (let t = 0; t < i.length; t += 1)
    i[t].swiperSlideOffset = e.isHorizontal()
      ? i[t].offsetLeft
      : i[t].offsetTop;
}
function _t(e = (this && this.translate) || 0) {
  const i = this,
    t = i.params,
    { slides: s, rtlTranslate: n, snapGrid: r } = i;
  ...
  for (let d = 0; d < s.length; d += 1) {
    ...
    const c =
        (a + (t.centeredSlides ? i.minTranslate() : 0) - o) /
        (l.swiperSlideSize + t.spaceBetween),
      u =
        (a - r[0] + (t.centeredSlides ? i.minTranslate() : 0) - o) /
        (l.swiperSlideSize + t.spaceBetween),
      f = -(a - o),
      h = f + i.slidesSizesGrid[d];
    ((f >= 0 && f < i.size - 1) ||
      (h > 1 && h <= i.size) ||
      (f <= 0 && h >= i.size)) &&
      (i.visibleSlides.push(l),
      i.visibleSlidesIndexes.push(d),
      s.eq(d).addClass(t.slideVisibleClass)),
      (l.progress = n ? -c : c),
      (l.originalProgress = n ? -u : u);
  }
  i.visibleSlides = m(i.visibleSlides);
}
function zt(e) {
  const i = this;
  if (typeof e > "u") {
  ...
  let { progress: n, isBeginning: r, isEnd: a } = i;
  const d = r,
    l = a;
  s === 0
    ? ((n = 0), (r = !0), (a = !0))
    : ((n = (e - i.minTranslate()) / s), (r = n <= 0), (a = n >= 1)),
    Object.assign(i, { progress: n, isBeginning: r, isEnd: a }),
    (t.watchSlidesProgress || (t.centeredSlides && t.autoHeight)) &&
      i.updateSlidesProgress(e),
    r && !d && i.emit("reachBeginning toEdge"),
    a && !l && i.emit("reachEnd toEdge"),
    ((d && !r) || (l && !a)) && i.emit("fromEdge"),
    i.emit("progress", n);
}
function At() {
  const e = this,
    { slides: i, params: t, $wrapperEl: s, activeIndex: n, realIndex: r } = e,
  ...
  a
    ...
    : (d = i.eq(n)),
    d.addClass(t.slideActiveClass),
    t.loop &&
      (d.hasClass(t.slideDuplicateClass)
        ? s
            .children(
              `.${t.slideClass}:not(.${t.slideDuplicateClass})[data-swiper-slide-index="${r}"]`
            )
            .addClass(t.slideDuplicateActiveClass)
        : s
            .children(
              `.${t.slideClass}.${t.slideDuplicateClass}[data-swiper-slide-index="${r}"]`
            )
            .addClass(t.slideDuplicateActiveClass));
  ...
  t.loop && o.length === 0 && ((o = i.eq(-1)), o.addClass(t.slidePrevClass)),
    t.loop &&
...
function kt(e) {
  ...
  if (n.indexOf(t) >= 0) c = n.indexOf(t);
    ...
    const f = Math.min(r.slidesPerGroupSkip, o);
    c = f + Math.floor((o - f) / r.slidesPerGroup);
  }
  if ((c >= n.length && (c = n.length - 1), o === a)) {
    c !== l && ((i.snapIndex = c), i.emit("snapIndexChange"));
    return;
  }
  const u = parseInt(i.slides.eq(o).attr("data-swiper-slide-index") || o, 10);
  Object.assign(i, {
    snapIndex: c,
    realIndex: u,
    previousIndex: a,
  ...
  if (s && n)
    (i.clickedSlide = s),
      i.virtual && i.params.virtual.enabled
        ? (i.clickedIndex = parseInt(m(s).attr("data-swiper-slide-index"), 10))
        : (i.clickedIndex = r);
  else {
...
const Nt = {
  ...
  updateActiveIndex: kt,
  updateClickedSlide: Dt,
};
function Gt(e = this.isHorizontal() ? "x" : "y") {
  const i = this,
    { params: t, rtlTranslate: s, translate: n, $wrapperEl: r } = i;
...
function jt(e = 0, i = this.params.speed, t = !0, s = !0, n) {
  const r = this,
  ...
  let c;
  if (
    (s && e > l ? (c = l) : s && e < o ? (c = o) : (c = e),
    r.updateProgress(c),
    a.cssMode)
  ) {
    const u = r.isHorizontal();
    if (i === 0) d[u ? "scrollLeft" : "scrollTop"] = -c;
    else {
      if (!r.support.smoothScroll)
        return (
          ge({ swiper: r, targetPosition: -c, side: u ? "left" : "top" }), !0
        );
  ...
  return (
    i === 0
      ? (r.setTransition(0),
        r.setTranslate(c),
        t && (r.emit("beforeTransitionStart", i, n), r.emit("transitionEnd")))
      : (r.setTransition(i),
        r.setTranslate(c),
        t && (r.emit("beforeTransitionStart", i, n), r.emit("transitionStart")),
        r.animating ||
          ((r.animating = !0),
...
function Wt(e = !0, i) {
  ...
  s.cssMode ||
    ...
    we({ swiper: t, runCallbacks: e, direction: i, step: "Start" }));
}
function qt(e = !0, i) {
  const t = this,
    { params: s } = t;
  (t.animating = !1),
    !s.cssMode &&
      (t.setTransition(0),
      we({ swiper: t, runCallbacks: e, direction: i, step: "End" }));
}
const Xt = { setTransition: Ft, transitionStart: Wt, transitionEnd: qt };
function Yt(e = 0, i = this.params.speed, t = !0, s, n) {
  ...
  if ((r.animating && d.preventInteractionOnTransition) || (!v && !s && !n))
    return !1;
  const w = Math.min(r.params.slidesPerGroupSkip, a);
  let g = w + Math.floor((a - w) / r.params.slidesPerGroup);
  g >= l.length && (g = l.length - 1);
  const p = -l[g];
  if (d.normalizeSlideIndex)
    for (let T = 0; T < o.length; T += 1) {
      const C = -Math.floor(p * 100),
        b = Math.floor(o[T] * 100),
        I = Math.floor(o[T + 1] * 100);
      typeof o[T + 1] < "u"
        ? C >= b && C < I - (I - b) / 2
          ? (a = T)
          : C >= b && C < I && (a = T + 1)
  ...
  if (
    ...
    return !1;
  a !== (c || 0) && t && r.emit("beforeSlideChangeStart"), r.updateProgress(p);
  let S;
  if (
    (a > u ? (S = "next") : a < u ? (S = "prev") : (S = "reset"),
    ...
    return (
      ...
      d.effect !== "slide" && r.setTranslate(p),
  ...
  if (d.cssMode) {
    ...
    if (i === 0) {
      ...
      if (!r.support.smoothScroll)
        return (
          ge({ swiper: r, targetPosition: C, side: T ? "left" : "top" }), !0
        );
...
function Kt(e = 0, i = this.params.speed, t = !0, s) {
  if (typeof e == "string") {
...
function Ut(e = this.params.speed, i = !0, t) {
  const s = this,
...
function Zt(e = this.params.speed, i = !0, t) {
  const s = this,
    {
      params: n,
      animating: r,
  ...
  if (
    ...
    const g =
      s.params.virtual && s.params.virtual.enabled && s.virtual
        ...
        : s.slides.length - 1;
    return s.slideTo(g, e, i, t);
  }
  return s.slideTo(w, e, i, t);
}
function Jt(e = this.params.speed, i = !0, t) {
  const s = this;
  return s.slideTo(s.activeIndex, e, i, t);
}
function Qt(e = this.params.speed, i = !0, t, s = 0.5) {
  const n = this;
  let r = n.activeIndex;
  ...
  if (l >= n.snapGrid[d]) {
    const o = n.snapGrid[d],
      c = n.snapGrid[d + 1];
    l - o > (c - o) * s && (r += n.params.slidesPerGroup);
  } else {
...
function ei() {
  const e = this,
    ...
    s = i.slidesPerView === "auto" ? e.slidesPerViewDynamic() : i.slidesPerView;
...
function ii() {
  ...
  if (t.loopFillGroupWithBlank) {
    ...
    if (l !== t.slidesPerGroup) {
      for (let o = 0; o < l; o += 1) {
        const c = m(i.createElement("div")).addClass(
  ...
  t.slidesPerView === "auto" && !t.loopedSlides && (t.loopedSlides = r.length),
  ...
  const a = [],
    d = [];
  r.each((l, o) => {
    m(l).attr("data-swiper-slide-index", o);
  });
  ...
  for (let l = 0; l < d.length; l += 1)
    n.append(m(d[l].cloneNode(!0)).addClass(t.slideDuplicateClass));
  for (let l = a.length - 1; l >= 0; l -= 1)
    n.prepend(m(a[l].cloneNode(!0)).addClass(t.slideDuplicateClass));
}
function si() {
  const e = this;
  ...
  i < s
    ? ((l = t.length - s * 3 + i),
      ...
      e.slideTo(l, 0, !1, !0) &&
        c !== 0 &&
        e.setTranslate((d ? -e.translate : e.translate) - c))
    : i >= t.length - s &&
      ((l = -t.length + i + s),
      (l += s),
      e.slideTo(l, 0, !1, !0) &&
...
function ni() {
  const e = this,
    { $wrapperEl: i, params: t, slides: s } = e;
  i
    .children(
...
const ri = { loopCreate: ii, loopFix: si, loopDestroy: ni };
function li(e) {
  const i = this;
  if (
    i.support.touch ||
...
const oi = { setGrabCursor: li, unsetGrabCursor: ai };
function di(e, i = this) {
  function t(s) {
    if (!s || s === z() || s === P()) return null;
...
function ci(e) {
  ...
  let o = m(l.target);
  if (
    (r.touchEventsTarget === "wrapper" && !o.closest(i.wrapperEl).length) ||
  ...
  c && l.target && l.target.shadowRoot && u && (o = m(u[0]));
  const f = r.noSwipingSelector ? r.noSwipingSelector : `.${r.noSwipingClass}`,
    h = !!(l.target && l.target.shadowRoot);
  if (r.noSwiping && (h ? di(f, o[0]) : o.closest(f)[0])) {
    i.allowClick = !0;
    return;
  }
  ...
  if (
    ...
    o.is(n.focusableElements) &&
      ...
      t.activeElement &&
        m(t.activeElement).is(n.focusableElements) &&
        t.activeElement !== o[0] &&
        t.activeElement.blur();
    const T = S && i.allowTouchMove && r.touchStartPreventDefault;
...
function fi(e) {
  const i = z(),
    t = this,
    s = t.touchEventsData,
    { params: n, touches: r, rtlTranslate: a, enabled: d } = t;
  if (!d) return;
  let l = e;
  ...
  const o =
    ...
    c = l.type === "touchmove" ? o.pageX : l.pageX,
    u = l.type === "touchmove" ? o.pageY : l.pageY;
  if (l.preventedByNestedSwiper) {
    (r.startX = c), (r.startY = u);
    return;
  }
  if (!t.allowTouchMove) {
    m(l.target).is(s.focusableElements) || (t.allowClick = !1),
      s.isTouched &&
  ...
  if (typeof s.isScrolling > "u") {
    ...
    (t.isVertical() && r.currentX === r.startX)
      ? (s.isScrolling = !1)
      : f * f + h * h >= 25 &&
        ((p = (Math.atan2(Math.abs(h), Math.abs(f)) * 180) / Math.PI),
  ...
  if (
    ...
    v > 0 && s.currentTranslate > t.minTranslate()
      ? ((w = !1),
        n.resistance &&
          (s.currentTranslate =
            t.minTranslate() -
            1 +
            (-t.minTranslate() + s.startTranslate + v) ** g))
      : v < 0 &&
        ...
        n.resistance &&
          (s.currentTranslate =
            t.maxTranslate() +
            1 -
            (t.maxTranslate() - s.startTranslate - v) ** g)),
...
function ui(e) {
  const i = this,
    t = i.touchEventsData,
    { params: s, touches: n, rtlTranslate: r, slidesGrid: a, enabled: d } = i;
  if (!d) return;
  let l = e;
  if (
    (l.originalEvent && (l = l.originalEvent),
    t.allowTouchCallbacks && i.emit("touchEnd", l),
    (t.allowTouchCallbacks = !1),
    !t.isTouched)
  ) {
    t.isMoved && s.grabCursor && i.setGrabCursor(!1),
      (t.isMoved = !1),
      (t.startMoving = !1);
    return;
  }
  ...
  if (i.allowClick) {
    ...
    i.updateClickedSlide((S && S[0]) || l.target),
      i.emit("tap click", l),
      c < 300 &&
        o - t.lastClickTime < 300 &&
        i.emit("doubleTap doubleClick", l);
  }
  if (
    ((t.lastClickTime = q()),
    ne(() => {
  ...
  if (
    (s.followFinger
      ? (u = r ? i.translate : -i.translate)
      : (u = -t.currentTranslate),
    s.cssMode)
  )
    return;
  if (i.params.freeMode && s.freeMode.enabled) {
    i.freeMode.onTouchEnd({ currentPos: u });
    return;
  }
  let f = 0,
  ...
  for (
    ...
    const T = S < s.slidesPerGroupSkip - 1 ? 1 : s.slidesPerGroup;
    typeof a[S + T] < "u"
      ? u >= a[S] && u < a[S + T] && ((f = S), (h = a[S + T] - a[S]))
      : u >= a[S] && ((f = S), (h = a[a.length - 1] - a[a.length - 2]));
  }
  let v = null,
    w = null;
  s.rewind &&
    (i.isBeginning
      ...
      : i.isEnd && (v = 0));
  const g = (u - a[f]) / h,
    p = f < s.slidesPerGroupSkip - 1 ? 1 : s.slidesPerGroup;
  if (c > s.longSwipesMs) {
    if (!s.longSwipes) {
    ...
    i.swipeDirection === "next" &&
      (g >= s.longSwipesRatio
        ? i.slideTo(s.rewind && i.isEnd ? v : f + p)
        : i.slideTo(f)),
      i.swipeDirection === "prev" &&
        (g > 1 - s.longSwipesRatio
          ? i.slideTo(f + p)
          : w !== null && g < 0 && Math.abs(g) > s.longSwipesRatio
          ? i.slideTo(w)
          : i.slideTo(f));
  } else {
    if (!s.shortSwipes) {
    ...
    i.navigation &&
    (l.target === i.navigation.nextEl || l.target === i.navigation.prevEl)
      ? l.target === i.navigation.nextEl
        ? i.slideTo(f + p)
        : i.slideTo(f)
      : (i.swipeDirection === "next" && i.slideTo(v !== null ? v : f + p),
        i.swipeDirection === "prev" && i.slideTo(w !== null ? w : f));
  }
}
function ce() {
  const e = this,
...
function hi() {
  const e = this,
    { wrapperEl: i, rtlTranslate: t, enabled: s } = e;
  if (!s) return;
...
const Se = (e, i) => {
  const t = z(),
    ...
    o = !!s.nested,
    c = i === "on" ? "addEventListener" : "removeEventListener",
    u = i;
  if (!l.touch)
    r[c](n.start, e.onTouchStart, !1),
      t[c](n.move, e.onTouchMove, o),
      t[c](n.end, e.onTouchEnd, !1);
  else {
    const f =
      n.start === "touchstart" && l.passiveListener && s.passiveListeners
        ? { passive: !0, capture: !1 }
        : !1;
    r[c](n.start, e.onTouchStart, f),
      r[c](
        n.move,
        e.onTouchMove,
        l.passiveListener ? { passive: !1, capture: o } : o
      ),
      r[c](n.end, e.onTouchEnd, f),
      n.cancel && r[c](n.cancel, e.onTouchEnd, f);
  }
...
function gi() {
  ...
  (e.onTouchStart = ci.bind(e)),
    ...
    t.cssMode && (e.onScroll = hi.bind(e)),
    (e.onClick = pi.bind(e)),
    s.touch && !fe && (i.addEventListener("touchstart", mi), (fe = !0)),
    Se(e, "on");
}
function vi() {
  Se(this, "off");
}
const wi = { attachEvents: gi, detachEvents: vi },
  ue = (e, i) => e.grid && i.grid && i.grid.rows > 1;
function Si() {
  const e = this,
    {
      activeIndex: i,
  ...
  c && !u
    ...
    ["navigation", "pagination", "scrollbar"].forEach((g) => {
      const p = n[g] && n[g].enabled,
        S = o[g] && o[g].enabled;
      p && !S && e[g].disable(), !p && S && e[g].enable();
    });
  const h = o.direction && o.direction !== n.direction,
    v = n.loop && (o.slidesPerView !== n.slidesPerView || h);
  h && t && e.changeDirection(), _(e.params, o);
  ...
  Object.assign(e, {
    ...
    v &&
      ...
      e.loopCreate(),
      e.updateSlides(),
      e.slideTo(i - s + e.loopedSlides, 0, !1)),
    e.emit("breakpoint", o);
}
function Ti(e, i = "window", t) {
  if (!e || (i === "container" && !t)) return;
  let s = !1;
  const n = P(),
    r = i === "window" ? n.innerHeight : t.clientHeight,
...
const bi = { setBreakpoint: Si, getBreakpoint: Ti };
function Ei(e, i) {
  const t = [];
  return (
    e.forEach((s) => {
...
function xi() {
  const e = this,
    { classNames: i, params: t, rtl: s, $el: n, device: r, support: a } = e,
    d = Ei(
      [
        "initialized",
        t.direction,
  ...
  i.push(...d), n.addClass([...i].join(" ")), e.emitContainerClasses();
}
function Ci() {
  const e = this,
    { $el: i, classNames: t } = e;
...
const yi = { addClasses: xi, removeClasses: Ci };
function Mi(e, i, t, s, n, r) {
  const a = P();
  let d;
  function l() {
    r && r();
  }
  !m(e).parent("picture")[0] && (!e.complete || !n) && i
    ? ((d = new a.Image()),
      (d.onload = l),
      (d.onerror = l),
      s && (d.sizes = s),
...
const Oi = { loadImage: Mi, preloadImages: Li };
function Pi() {
  const e = this,
...
let j = class k {
  constructor(...i) {
    ...
    (n.__swiper__ = !0),
      (n.support = ve()),
      (n.device = Et({ userAgent: s.userAgent })),
      (n.browser = Ct()),
      (n.eventsListeners = {}),
  ...
  emitSlidesClasses() {
    ...
    i.slides.each((s) => {
      ...
      t.push({ slideEl: s, classNames: n }), i.emit("_slideClass", s, n);
    }),
  ...
  slidesPerViewDynamic(i = "current", t = !1) {
    ...
    let c = 1;
    if (n.centeredSlides) {
      let u = r[o].swiperSlideSize,
        f;
      for (let h = o + 1; h < r.length; h += 1)
        r[h] &&
          !f &&
          ((u += r[h].swiperSlideSize), (c += 1), u > l && (f = !0));
      ...
      for (let u = o + 1; u < r.length; u += 1)
        (t ? a[u] + d[u] - a[o] < l : a[u] - a[o] < l) && (c += 1);
    else for (let u = o - 1; u >= 0; u -= 1) a[o] - a[u] < l && (c += 1);
    return c;
  }
  update() {
    const i = this;
  ...
  changeDirection(i, t = !0) {
    ...
    return (
      i || (i = n === "horizontal" ? "vertical" : "horizontal"),
      i === n ||
  ...
  mount(i) {
    ...
    let a = (() => {
      if (i && i.shadowRoot && i.shadowRoot.querySelector) {
        const d = m(i.shadowRoot.querySelector(n()));
        return (d.children = (l) => s.children(l)), d;
      }
      return s.children ? s.children(n()) : m(s).children(n());
    })();
    if (a.length === 0 && t.params.createElements) {
      const l = z().createElement("div");
      (a = m(l)),
        (l.className = t.params.wrapperClass),
        s.append(l),
        s.children(`.${t.params.slideClass}`).each((o) => {
          a.append(o);
        });
    }
    return (
      Object.assign(t, {
        ...
        wrapperEl: a[0],
        mounted: !0,
        rtl: i.dir.toLowerCase() === "rtl" || s.css("direction") === "rtl",
        rtlTranslate:
          t.params.direction === "horizontal" &&
          (i.dir.toLowerCase() === "rtl" || s.css("direction") === "rtl"),
  ...
  static use(i) {
    return Array.isArray(i)
      ? (i.forEach((t) => k.installModule(t)), k)
      : (k.installModule(i), k);
  }
};
Object.keys(ie).forEach((e) => {
  Object.keys(ie[e]).forEach((i) => {
    j.prototype[i] = ie[e][i];
  });
});
j.use([yt, Mt]);
function B(e) {
...
function N(e, i) {
  ...
  Object.keys(i)
    ...
    .forEach((s) => {
      typeof e[s] > "u"
        ? (e[s] = i[s])
        : B(i[s]) && B(e[s]) && Object.keys(i[s]).length > 0
        ? i[s].__swiper__
          ? (e[s] = i[s])
          : N(e[s], i[s])
        : (e[s] = i[s]);
...
function _i(e = {}, i = !0) {
  const t = { on: {} },
    ...
    n = {};
  N(t, j.defaults),
    N(t, j.extendedDefaults),
    (t._emitClasses = !0),
    (t.init = !1);
  const r = {},
    a = Ce.map((l) => l.replace(/_/, "")),
    d = Object.assign({}, e);
  return (
...
function zi(
  { el: e, nextEl: i, prevEl: t, paginationEl: s, scrollbarEl: n, swiper: r },
  a
) {
  Te(a) &&
    i &&
    t &&
    ((r.params.navigation.nextEl = i),
    (r.originalParams.navigation.nextEl = i),
...
const ye = (e, i) => {
  ...
  if (i.breakpoints) {
    const n = j.prototype.getBreakpoint(i.breakpoints),
      r = n in i.breakpoints ? i.breakpoints[n] : void 0;
    r && r.slidesPerView && (t = r.slidesPerView);
  }
  let s = Math.ceil(parseFloat(i.loopedSlides || t, 10));
  return (
    (s += i.loopAdditionalSlides),
    s > e.length && i.loopedSlidesLimit && (s = e.length),
    s
  );
};
function Ai(e, i, t) {
  const s = i.map((l, o) =>
    O.cloneElement(l, { swiper: e, "data-swiper-slide-index": o })
  );
  function n(l, o, c) {
    return O.cloneElement(l, {
      key: `${l.key}-duplicate-${o}-${c}`,
      className: `${l.props.className || ""} ${t.slideDuplicateClass}`,
    });
  }
  if (t.loopFillGroupWithBlank) {
  ...
  const r = ye(s, t),
    ...
    d = [];
  for (let l = 0; l < r; l += 1) {
    const o = l - Math.floor(l / s.length) * s.length;
    d.push(n(s[o], l, "append")),
      a.unshift(n(s[s.length - o - 1], l, "prepend"));
  }
  return e && (e.loopedSlides = r), [...a, ...s, ...d];
}
function ki(e, i, t, s, n) {
  const r = [];
  if (!i) return r;
  const a = (l) => {
...
function Le(e) {
  const i = [];
  return (
    O.Children.toArray(e).forEach((t) => {
      Me(t)
        ? i.push(t)
        : t.props &&
          t.props.children &&
          Le(t.props.children).forEach((s) => i.push(s));
    }),
    i
  );
}
function Di(e) {
  ...
  return (
    O.Children.toArray(e).forEach((s) => {
      if (Me(s)) i.push(s);
      else if (s.props && s.props.slot && t[s.props.slot])
        t[s.props.slot].push(s);
      else if (s.props && s.props.children) {
        const n = Le(s.props.children);
        n.length > 0 ? n.forEach((r) => i.push(r)) : t["container-end"].push(s);
...
function Ni({
  ...
  const l = s.filter((b) => b !== "children" && b !== "direction"),
    {
      params: o,
      pagination: c,
      navigation: u,
    ...
    e[b] &&
      ...
      b === "navigation"
        ? ((o[b].prevEl = void 0),
          ...
          (e[b].prevEl = void 0),
          (e[b].nextEl = void 0))
        : ((o[b].el = void 0), (e[b].el = void 0)));
  };
  l.forEach((b) => {
    if (B(o[b]) && B(t[b])) N(o[b], t[b]);
    else {
      const I = t[b];
      (I === !0 || I === !1) &&
    ...
    s.includes("children") && i && h && o.virtual.enabled
    ...
    p && (d && (o.pagination.el = d), c.init(), c.render(), c.update()),
    S &&
      (a && (o.scrollbar.el = a), f.init(), f.updateSize(), f.setTranslate()),
    T &&
...
function Gi(e, i, t) {
  ...
  const s = e.isHorizontal()
    ...
    : { top: `${t.offset}px` };
  return i
    .filter((n, r) => r >= t.from && r <= t.to)
    .map((n) => O.cloneElement(n, { swiper: e, style: s }));
}
const Bi = (e) => {
  !e ||
    e.destroyed ||
...
function W(e, i) {
  return typeof window > "u" ? L.useEffect(e, i) : L.useLayoutEffect(e, i);
}
const Vi = L.createContext(null),
  Ri = L.createContext(null);
function re() {
  return (
    (re = Object.assign
      ? Object.assign.bind()
...
const ji = L.forwardRef(function (e, i) {
  let {
      className: t,
      tag: s = "div",
      wrapperTag: n = "div",
  ...
  const [o, c] = L.useState("swiper"),
    ...
    I = L.useRef(null),
    G = L.useRef(null),
    { params: M, passedParams: H, rest: x, events: E } = _i(d),
    { slides: y, slots: A } = Di(r),
    V = () => {
      v(!h);
    };
  Object.assign(M.on, {
  ...
  const F = () => {
    if (
      ...
      N(p.current.params.virtual, $), N(p.current.originalParams.virtual, $);
    }
  };
  g.current || F(), p.current && p.current.on("_beforeBreakpoint", V);
  const Z = () => {
      l ||
        !E ||
        !p.current ||
  ...
  L.useEffect(() => () => {
    ...
    L.useEffect(() => {
      !w.current &&
        p.current &&
        (p.current.emitSlidesClasses(), (w.current = !0));
    }),
    W(() => {
      if ((i && (i.current = g.current), !!g.current))
        return (
          p.current.destroyed && F(),
          zi(
            {
              el: g.current,
              nextEl: C.current,
    ...
    W(() => {
      Z();
      const $ = ki(H, S.current, y, T.current, (R) => R.key);
      return (
        (S.current = H),
        (T.current = y),
        $.length &&
  ...
  function Y() {
    return M.virtual
      ? Gi(p.current, y, u)
      : !M.loop || (p.current && p.current.destroyed)
      ? y.map(($) => O.cloneElement($, { swiper: p.current }))
      : Ai(p.current, y, M);
  }
  return O.createElement(
    s,
    re({ ref: g, className: xe(`${o}${t ? ` ${t}` : ""}`) }, x),
    O.createElement(
      Ri.Provider,
      { value: p.current },
      A["container-start"],
      ...
      Te(M) &&
        O.createElement(
          O.Fragment,
          null,
          O.createElement("div", { ref: b, className: "swiper-button-prev" }),
          O.createElement("div", { ref: C, className: "swiper-button-next" })
        ),
      Ee(M) &&
        O.createElement("div", { ref: G, className: "swiper-scrollbar" }),
      be(M) &&
        O.createElement("div", { ref: I, className: "swiper-pagination" }),
      A["container-end"]
    )
  );
});
ji.displayName = "Swiper";
function le() {
  return (
    (le = Object.assign
      ? Object.assign.bind()
...
const Hi = L.forwardRef(function (e, i) {
  let {
    tag: t = "div",
    children: s,
    className: n = "",
  ...
  const o = L.useRef(null),
    [c, u] = L.useState("swiper-slide");
  function f(w, g, p) {
    g === o.current && u(p);
  }
  W(() => {
    if ((i && (i.current = o.current), !(!o.current || !r))) {
      if (r.destroyed) {
      ...
      return (
        r.on("_slideClass", f),
        () => {
          r && r.off("_slideClass", f);
        }
      );
    }
  }),
    W(() => {
      r && o.current && !r.destroyed && u(r.getSlideClasses(o.current));
    }, [r]);
  const h = {
      isActive:
...
Hi.displayName = "SwiperSlide";
export { m as $, ji as S, Hi as a, j as b, z as g, ne as n };
