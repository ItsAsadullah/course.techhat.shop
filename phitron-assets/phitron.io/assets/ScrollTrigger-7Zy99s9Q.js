 ...
 */ var ve,
  ...
  Lr = "scrollTop",
  pn = function () {
    return (yt && yt.isPressed) || P.cache++;
  },
  Qr = function (e, n) {
    var t = function r(i) {
      if (i || i === 0) {
        ...
        (i = r.v = Math.round(i) || (yt && yt.iOS ? 1 : 0)),
          e(i),
          (r.cacheID = P.cache),
          u && fn("ss", i);
      } else
        (n || P.cache !== r.cacheID || fn("ref")) &&
          ((r.cacheID = P.cache), (r.v = e()));
      return r.v + r.offset;
    };
  ...
  Ie = {
    ...
    sc: Qr(function (o) {
      return arguments.length
        ? Ve.scrollTo(o, ae.sc())
        : Ve.pageXOffset || Dt[Yr] || Rt[Yr] || ir[Yr] || 0;
    }),
  },
  ae = {
    s: Lr,
    ...
    sc: Qr(function (o) {
      return arguments.length
        ? Ve.scrollTo(Ie.sc(), o)
        : Ve.pageYOffset || Dt[Lr] || Rt[Lr] || ir[Lr] || 0;
    }),
  },
  Be = function (e, n) {
    return (
    ...
    var r = e,
      ...
      g = function (v) {
        ...
        return (
          ...
          u === l || ne - l > S
            ? 0
            : ((r + (t ? B : -B)) / ((t ? ne : u) - U)) * 1e3
        );
      };
    return { update: R, reset: k, getVelocity: g };
  },
  dr = function (e, n) {
    return (
      n && !e._gsapAllow && e.cancelable !== !1 && e.preventDefault(),
  ...
  jn = function () {
    (or = ve.core.globals().ScrollTrigger), or && or.core && bi();
  },
  ei = function (e) {
    return (
      (ve = e || Jn()),
      !$r &&
        ...
        (Kn = [Ve, Dt, Rt, ir]),
        ve.utils.clamp,
        (Zn = ve.core.context || function () {}),
        (Bt = "onpointerenter" in ir ? "pointer" : "mouse"),
        (qn = J.isTouch =
          Ve.matchMedia &&
...
var J = (function () {
  ...
  return (
    (e.init = function (t) {
      $r || ei(ve) || console.warn("Please gsap.registerPlugin(Observer)"),
        or || jn();
      var r = t.tolerance,
        i = t.dragMinimum,
        u = t.type,
      ...
      (this.target = l = Be(l) || Rt),
        ...
        (S = S !== !1),
        p || (p = parseFloat(Ve.getComputedStyle(ir).lineHeight) || 22);
      var Ct,
        De,
        Re,
        Y,
        ...
        te = function (m, L) {
          return (
            ((a.event = m) && c && wi(m.target, c)) ||
            (L && ce && m.pointerType !== "touch") ||
            (z && z(m, L))
          );
        },
        Rr = function () {
        ...
        vt = function () {
          var m = (a.deltaX = Dn(et)),
            ...
            f = Math.abs(m) >= r,
            b = Math.abs(L) >= r;
          ue && (f || b) && ue(a, m, L, et, Ze),
            f &&
              (qe && a.deltaX > 0 && qe(a),
              X && a.deltaX < 0 && X(a),
              ze && ze(a),
              x && a.deltaX < 0 != He < 0 && x(a),
              (He = a.deltaX),
              (et[0] = et[1] = et[2] = 0)),
            b &&
              (ke && a.deltaY > 0 && ke(a),
        ...
        Kt = function (m, L, f) {
          (et[f] += m),
            ...
            a._vx.update(m),
            a._vy.update(L),
            S ? Ct || (Ct = requestAnimationFrame(vt)) : vt();
        },
        Zt = function (m, L) {
          Pe &&
            !Xe &&
            ((a.axis = Xe = Math.abs(m) > Math.abs(L) ? "x" : "y"), (Ne = !0)),
            Xe !== "y" && ((et[2] += m), a._vx.update(m, !0)),
            Xe !== "x" && ((Ze[2] += L), a._vy.update(L, !0)),
            S ? Ct || (Ct = requestAnimationFrame(vt)) : vt();
        },
        Et = function (m) {
          if (!te(m, 1)) {
            ...
            (a.x = L),
              ...
              (w ||
                ((b || _) &&
                  (Math.abs(a.startX - L) >= i ||
                    Math.abs(a.startY - f) >= i))) &&
                (Re || (Re = w ? 2 : 1), w || (a.isDragging = !0), Zt(b, _));
          }
        },
        Ft = (a.onPress = function (C) {
          te(C, 1) ||
            ...
            (C = dr(C)),
            (He = gt = 0),
            (a.startX = a.x = C.clientX),
            (a.startY = a.y = C.clientY),
            a._vx.reset(),
            a._vy.reset(),
            Ae(Q ? l : K, ot[1], Et, St, !0),
            (a.deltaX = a.deltaY = 0),
            ge && ge(a));
        }),
        D = (a.onRelease = function (C) {
          if (!te(C, 1)) {
            Oe(Q ? l : K, ot[1], Et, !0);
            ...
            !f &&
              ...
              R &&
                ...
                ve.delayedCall(0.08, function () {
                  if (yr() - _t > 300 && !C.defaultPrevented) {
        ...
        nt = function (m) {
          if (!te(m)) {
            (m = dr(m, R)), oe && (q = !0);
            var L =
              (m.deltaMode === 1 ? p : m.deltaMode === 2 ? Ve.innerHeight : 1) *
              v;
            Kt(m.deltaX * L, m.deltaY * L, 0), k && !Q && De.restart(!0);
          }
        },
        zt = function (m) {
          if (!te(m)) {
        ...
        cr = function (m) {
          return te(m) || (dr(m, R) && Ke(a));
        };
      (De = a._dc = ve.delayedCall(g || 0.25, Rr).pause()),
        (a.deltaX = a.deltaY = 0),
        (a._vx = dn(0, 50, !0)),
        (a._vy = dn(0, 50, !0)),
        (a.scrollX = $),
        ...
        (a.enable = function (C) {
          return (
            a.isEnabled ||
              (Ae(kt ? K : l, "scroll", pn),
              u.indexOf("scroll") >= 0 && Ae(kt ? K : l, "scroll", rt, St, me),
              u.indexOf("wheel") >= 0 && Ae(l, "wheel", nt, St, me),
              ((u.indexOf("touch") >= 0 && qn) || u.indexOf("pointer") >= 0) &&
                (Ae(l, ot[0], Ft, St, me),
                Ae(K, ot[2], D),
                Ae(K, ot[3], D),
                ee && Ae(l, "click", ur, !0, !0),
                Ke && Ae(l, "click", cr),
                j && Ae(K, "gesturestart", It),
                s && Ae(K, "gestureend", tt),
                ie && Ae(l, Bt + "enter", Jt),
                Ee && Ae(l, Bt + "leave", mt),
                Me && Ae(l, Bt + "move", zt)),
              (a.isEnabled = !0),
              (a.isDragging = a.isGesturing = a.isPressed = Y = Re = !1),
              a._vx.reset(),
              a._vy.reset(),
              (Tt = $()),
              (Lt = ht()),
        ...
        (a.disable = function () {
          a.isEnabled &&
            (nr.filter(function (C) {
              return C !== a && br(C.target);
            }).length || Oe(kt ? K : l, "scroll", pn),
            a.isPressed &&
              (a._vx.reset(), a._vy.reset(), Oe(Q ? l : K, ot[1], Et, !0)),
            Oe(kt ? K : l, "scroll", rt, me),
            Oe(l, "wheel", nt, me),
            Oe(l, ot[0], Ft, me),
            Oe(K, ot[2], D),
            Oe(K, ot[3], D),
 ...
 */ var d,
  ...
  Yn = function (e, n) {
    return n && (!Ue(e) || e.substr(0, 6) !== "clamp(")
      ? "clamp(" + e + ")"
      : e;
  },
  Ci = function o() {
    return _r && requestAnimationFrame(o);
  },
  Ln = function () {
    return (rn = 1);
  },
  ...
  Hr = function (e, n, t, r, i, u, l, p) {
    var S = i.startColor,
      ...
      U = $t(t) || Ot(t, "pinType") === "fixed",
      B = e.indexOf("scroller") !== -1,
      ne = U ? F : t.tagName === "IFRAME" ? t.contentDocument.body : t,
      W = e.indexOf("start") !== -1,
      ge = W ? S : R,
      T =
        "border-color:" +
    ...
    return (
      (T += "position:" + ((B || p) && U ? "fixed;" : "absolute;")),
      (B || p || !U) &&
        (T += (r === ae ? Sn : Tn) + ":" + (u + parseFloat(g)) + "px;"),
      l &&
        (T +=
  ...
  er = function () {
    (!Ye || !Ye.isPressed || Ye.startX > F.clientWidth) &&
      (P.cache++,
      Ye ? Dr || (Dr = requestAnimationFrame(bt)) : bt(),
      je || qt("scrollStart"),
      (je = Se()));
  },
  an = function () {
    (ii = M.innerWidth), (ni = M.innerHeight);
  },
  xr = function (e) {
    P.cache++,
      (e === !0 ||
        (!Ce &&
          ...
          (!hn ||
            ii !== M.innerWidth ||
            Math.abs(M.innerHeight - ni) > M.innerHeight * 0.25))) &&
        jr.restart(!0);
  },
  Vt = {},
  Pi = [],
  pi = function o() {
    return pe(O, "scrollEnd", o) || Ht(!0);
  },
  qt = function (e) {
    return (
      (Vt[e] &&
  ...
  hi = function (e, n) {
    P.cache++,
      ...
      Ue(e) && (M.history.scrollRestoration = wn = e);
  },
  Fe,
  Ut = 0,
  Bn,
  ...
  _i = function () {
    F.appendChild(sr),
      (Cn = (!Ye && sr.offsetHeight) || M.innerHeight),
      F.removeChild(sr);
  },
  Xn = function (e) {
    return Pr(
  ...
  bt = function (e) {
    if (e === 2 || (!Fe && !Cr)) {
      ...
      if (
        ...
        for (Le = n; Le-- > 0; ) E[Le] && E[Le].update(0, r);
        Kr = 1;
      } else for (Le = 0; Le < n; Le++) E[Le] && E[Le].update(0, r);
      O.isUpdating = !1;
    }
    Dr = 0;
  },
    ...
    if (e) {
      ...
      for ((e.t._gsap || d.core.getCache(e.t)).uncache = 1; r < t; r += 2)
        (u = e[r + 1]),
          ...
          u
            ? (n[i] = u)
            : n[i] && n.removeProperty(i.replace(Oi, "-$1").toLowerCase());
    }
  },
  Wr = function (e) {
    for (var n = Zr.length, t = e.style, r = [], i = 0; i < n; i++)
      r.push(Zr[i], t[Zr[i]]);
    return (r.t = e), r;
  },
  Ai = function (e, n, t) {
  ...
  Jr = { left: 0, top: 0 },
  Hn = function (e, n, t, r, i, u, l, p, S, R, k, g, c, v) {
    Te(e) && (e = e(p)),
      Ue(e) &&
        e.substr(0, 3) === "max" &&
        (e = g + (e.charAt(4) === "=" ? Vr("0" + e.substr(3), t) : 0));
    var U = c ? c.time() : 0,
      B,
      ne,
      W;
    if ((c && c.seek(0), isNaN(e) || (e = +e), mr(e)))
      ...
      (W = Be(n, p) || F),
        ...
        (qe = Vr(ge[0], T[r.d])),
        (X = Vr(ge[1] || "0", t)),
        (e = T[r.p] - S[r.p] - R + qe + i - X),
        l && qr(l, X, r, t - X < 20 || (l._isStart && X > 20)),
        (t -= t - X);
    }
    if ((v && ((p[v] = e || -0.001), e < 0 && (e = 0)), u)) {
      ...
      (B = "scroll" + r.d2),
        qr(
          ...
          r,
          (ze && ke > 20) ||
            (!ze && (k ? Math.max(F[B], $e[B]) : u.parentNode[B]) <= ke + 1)
        ),
        k &&
          ((S = xt(l)),
          k && (u.style[r.op.p] = S[r.op.p] - r.op.m - u._offset + le));
    }
    return (
      c &&
        W &&
        ...
        c.seek(g),
        (ne = xt(W)),
        (c._caScrollDist = B[r.p] - ne[r.p]),
        (e = (e / c._caScrollDist) * g)),
      c && c.seek(U),
      c ? e : Math.round(e)
    );
  },
  Yi = /(webkit|moz|length|cssText|inset)/i,
  Wn = function (e, n, t, r) {
    if (e.parentNode !== n) {
      var i = e.style,
        u,
  ...
  Gn = function (e, n) {
    var t = At(e, n),
      r = "_scroll" + n.p2,
      i = function u(l, p, S, R, k) {
        var g = u.tween,
          c = p.onComplete,
          v = {};
        S = S || t();
        var U = vi(t, S, function () {
          g.kill(), (u.tween = 0);
        });
        return (
          (k = (R && k) || 0),
          ...
          (p.modifiers = v),
          (v[r] = function () {
            return U(S + R * g.ratio + k * g.ratio * g.ratio);
          }),
          (p.onUpdate = function () {
            P.cache++, u.tween && bt();
          }),
    ...
    return (
      ...
      O.isTouch && de(e, "touchmove", t.wheelHandler),
      i
    );
  },
  O = (function () {
    ...
    return (
      (e.init = function (t, r) {
        ...
        t = In(Ue(t) || mr(t) || t.nodeType ? { trigger: t } : t, Xr);
        var i = t,
          u = i.onUpdate,
          l = i.toggleClass,
          p = i.id,
        ...
        if (
          ...
          "refreshPriority" in t &&
            ((ti = 1), t.refreshPriority === -9999 && (Mr = s)),
          (pt.tweenScroll = pt.tweenScroll || {
            top: Gn(x, ae),
            left: Gn(x, Ie),
          }),
          (s.tweenTo = Pe = pt.tweenScroll[h.p]),
          ...
          r &&
            ...
            p || (p = r.vars.id)),
          T &&
            ((!Xt(T) || T.push) && (T = { snapTo: T }),
            "scrollBehavior" in F.style &&
              d.set(ie ? [F, $e] : x, { scrollBehavior: "auto" }),
            P.forEach(function (f) {
              return (
                Te(f) &&
                f.target === (ie ? I.scrollingElement || $e : x) &&
                (f.smooth = !1)
              );
            }),
            (Ct = Te(T.snapTo)
              ...
              : T.directional !== !1
              ? function (f, b) {
                  return En(T.snapTo)(f, Se() - dt < 500 ? 0 : b.direction);
                }
              : d.utils.snap(T.snapTo)),
            (tt = T.duration || { min: 0.1, max: 2 }),
            (tt = Xt(tt) ? wr(tt.min, tt.max) : wr(tt, tt)),
            (rt = d
              .delayedCall(T.delay || It / 2 || 0.1, function () {
                var f = ee(),
                  b = Se() - dt < 500,
                  _ = Pe.tween;
                if (
                  (b || Math.abs(s.getVelocity()) < 10) &&
                  !_ &&
                  !rn &&
                  Ke !== f
                ) {
                  var w = (f - Y) / $,
                    fe = r && !ue ? r.totalProgress() : w,
                    A = b ? 0 : ((fe - Ft) / (Se() - hr)) * 1e3 || 0,
                    Z = d.utils.clamp(-w, 1 - w, (jt(A / 2) * A) / 0.185),
                    ye = w + (T.inertia === !1 ? 0 : Z),
                    V,
                    H,
                    N = T,
                    it = N.onStart,
                    ...
                    T.inertia === !1 && (Z = V - w),
                      Pe(
                        H,
                        {
                          duration: tt(
                            jt(
                              (Math.max(jt(ye - fe), jt(V - fe)) * 0.185) /
                                A /
                                0.05 || 0
                            )
                          ),
              ...
              .pause())),
          p && (mn[p] = s),
          (g = s.trigger = Be(g || (c !== !0 && c))),
          (mt = g && g._gsap && g._gsap.stRevert),
          mt && (mt = mt(s)),
          (c = c === !0 ? g : Be(c)),
          Ue(l) && (l = { targets: g, className: l }),
          c &&
            (v === !1 ||
              v === Je ||
              (v =
            ...
            xe.spacer
              ...
              : (X &&
                ...
                (xe.spacer = ce = X || I.createElement("div")),
                ce.classList.add("pin-spacer"),
                p && ce.classList.add("pin-spacer-" + p),
                (xe.pinState = ht = Wr(c))),
            t.force3D !== !1 && d.set(c, { force3D: !0 }),
            (s.spacer = ce = xe.spacer),
            (Zt = Qe(c)),
            (ur = Zt[v + h.os2]),
            (K = d.getProperty(c)),
            (et = d.quickSetter(c, h.a, le)),
            un(c, ce, Zt),
            (Lt = Wr(c))),
          Q)
        ) {
          (gt = Xt(Q) ? In(Q, zn) : zn),
            (a = Hr("scroller-start", p, x, h, gt, 0)),
            (He = Hr("scroller-end", p, x, h, gt, 0, a)),
            (kt = a["offset" + h.op.d2]);
          var cr = Be(Ot(x, "content") || x);
          (Ne = this.markerStart = Hr("start", p, cr, h, gt, kt, 0, y)),
            (Xe = this.markerEnd = Hr("end", p, cr, h, gt, kt, 0, y)),
            y && (Jt = d.quickSetter([Ne, Xe], h.a, le)),
            !Ee &&
              !(ft.length && Ot(x, "fixedMarkers") === !0) &&
              (ki(ie ? F : x),
              d.set([a, He], { force3D: !0 }),
              (Rr = d.quickSetter(a, h.a, le)),
              (Kt = d.quickSetter(He, h.a, le)));
        }
        if (y) {
          var C = y.vars.onUpdate,
            m = y.vars.onUpdateParams;
          y.eventCallback("onUpdate", function () {
            s.update(0, 0, 1), C && C.apply(y, m || []);
          });
        }
        if (
          ((s.previous = function () {
          ...
          (s.revert = function (f, b) {
            ...
            _ !== s.isReverted &&
              (_ &&
                ...
                (zt = r && r.progress())),
              Ne &&
                [Ne, Xe, a, He].forEach(function (fe) {
                  return (fe.style.display = _ ? "none" : "block");
                }),
              _ && ((Ce = s), s.update(_)),
              c &&
                (!qe || !s.isActive) &&
                (_ ? Ri(c, ce, ht) : un(c, ce, Qe(c), te)),
              _ || s.update(_),
              (Ce = w),
              (s.isReverted = _));
          }),
            ...
            if (!((Ce || !s.enabled) && !b)) {
              ...
              !Fe && oe && oe(s),
                ...
                U &&
                  ...
                  r.getChildren
                    ? r.getChildren(!0, !0, !1).forEach(function (Mt) {
              ...
              var fe = Yt(),
                ...
                G = Xt(_)
                  ? _.start
                  : t.start || (t.start === 0 || !g ? 0 : c ? "0 0" : "0 100%"),
                We = (s.pinnedContainer =
                  t.pinnedContainer && Be(t.pinnedContainer, s)),
                st = (g && Math.max(0, E.indexOf(s))) || 0,
                he = st,
                _e,
                be,
                Nt,
              ...
              for (
                Q &&
                Xt(_) &&
                ((pr = d.getProperty(a, h.p)), (Ar = d.getProperty(He, h.p)));
                he-- > 0;
              ...
              for (
                ...
                (se = E[he] || {}),
                  (lt = se.pin),
                  lt &&
                    se.start - se._pinPush <= Y &&
                    !y &&
                    se.end > 0 &&
                    ((_e =
                      se.end -
                      (s._startClamp ? Math.max(0, se.start) : se.start)),
                    ((lt === g && se.start - se._pinPush < Y) || lt === We) &&
                      isNaN(G) &&
                      (V += _e * (1 - se.progress)),
                    lt === c && (H += _e));
              if (
                ...
                s._endClamp &&
                  !Fe &&
                  ((s._endClamp = q || -0.001), (q = Math.min(q, ct(x, h)))),
                ($ = q - Y || ((Y -= 0.01) && 0.001)),
                ye && (me = d.utils.clamp(0, 1, d.utils.normalize(Y, q, nt))),
                (s._pinPush = H),
                Ne &&
                  V &&
                  ((_e = {}),
                ...
                (_e = Qe(c)),
                  (Or = h === ae),
                  (Nt = ee()),
                  (Ze = parseFloat(K(h.a)) + H),
                  !Z &&
                    q > 1 &&
                    ((at = (ie ? I.scrollingElement || $e : x).style),
                    (at = {
                      style: at,
                      value: at["overflow" + h.a.toUpperCase()],
                    }),
                    ie &&
                      Qe(F)["overflow" + h.a.toUpperCase()] !== "scroll" &&
                      (at.style["overflow" + h.a.toUpperCase()] = "scroll")),
                  un(c, ce, _e),
                  (Lt = Wr(c)),
                  (be = xt(c, !0)),
                  (nn = Ee && At(x, Or ? Ie : ae)()),
                    ...
                    ? ((te = [v + h.os2, $ + H + le]),
                      ...
                      he &&
                        ...
                        ce.style.flexBasis !== "auto" &&
                          (ce.style.flexBasis = he + le)),
                      lr(te),
                      We &&
                        E.forEach(function (Mt) {
                          Mt.pin === We &&
                            Mt.vars.pinSpacing !== !1 &&
                            (Mt._subPinOffset = !0);
                        }),
                      Ee && ee(nt))
                    : ((he = en(c, h)),
                  ...
                  Ee &&
                    ((we = {
                      top: be.top + (Or ? Nt - Y : nn) + le,
                      left: be.left + (Or ? nn : Nt - Y) + le,
                      boxSizing: "border-box",
                      position: "fixed",
                    }),
                    (we[Wt] = we["max" + ar] = Math.ceil(be.width) + le),
                    (we[Gt] = we["max" + kn] = Math.ceil(be.height) + le),
                    (we[Je] =
                      we[Je + kr] =
                      we[Je + Sr] =
                      we[Je + Er] =
                  ...
                  at &&
                    (at.value
                      ? (at.style["overflow" + h.a.toUpperCase()] = at.value)
                      : at.style.removeProperty("overflow-" + h.a));
              else if (g && ee() && !y)
                for (be = g.parentNode; be && be !== F; )
                  be._pinOffset && ((Y -= be._pinOffset), (q -= be._pinOffset)),
                    (be = be.parentNode);
              fr &&
                fr.forEach(function (Mt) {
                  return Mt.revert(!1, !0);
                }),
                (s.start = Y),
                (s.end = q),
                (De = Re = Fe ? nt : ee()),
                !y && !Fe && (De < nt && ee(nt), (s.scroll.rec = 0)),
                s.revert(!1, !0),
                (dt = Se()),
                ...
                (ye || me !== s.progress || y || U || (r && !r._initted)) &&
                  (r &&
                    !ue &&
                    (r._initted || me || r.vars.immediateRender !== !1) &&
                    r.totalProgress(
                      y && Y < -0.001 && !me ? d.utils.normalize(Y, q, 0) : me,
                      !0
                    ),
                  (s.progress = ye || (De - Y) / $ === me ? 0 : me)),
                c && v && (ce._pinOffset = Math.round(s.progress * _t)),
                D && D.invalidate(),
                isNaN(pr) ||
                  ((pr -= d.getProperty(a, h.p)),
                  (Ar -= d.getProperty(He, h.p)),
                  Gr(a, h, pr),
                  Gr(Ne, h, pr - (w || 0)),
                  Gr(He, h, Ar),
                  Gr(Xe, h, Ar - (w || 0))),
                ye && !Fe && s.update(),
                R && !Fe && !St && ((St = !0), R(s), (St = !1));
            }
          }),
          ...
          (s.labelToScroll = function (f) {
            return (
              (r &&
                r.labels &&
                (Y || s.refresh() || Y) + (r.labels[f] / r.duration()) * $) ||
              0
            );
          }),
          (s.getTrailing = function (f) {
            var b = E.indexOf(s),
              _ = s.direction > 0 ? E.slice(0, b).reverse() : E.slice(b + 1);
            return (
              Ue(f)
                ? _.filter(function (w) {
              ...
              return s.direction > 0 ? w.end <= Y : w.start >= q;
            });
          }),
          (s.update = function (f, b, _) {
            if (!(y && !_ && !f)) {
              var w = Fe === !0 ? nt : s.scroll(),
                fe = f ? 0 : (w - Y) / $,
              ...
              if (
                (b &&
                  ((Re = De),
                  (De = y ? ee() : w),
                  T && ((Ft = Et), (Et = r && !ue ? r.totalProgress() : A))),
                B &&
                  c &&
                  !Ce &&
                  !Ir &&
                ...
                if (
                  ...
                  it &&
                    !Ce &&
                    ((H = A && !Z ? 0 : A === 1 ? 1 : Z === 1 ? 2 : 3),
                    ue &&
                      ((N = (!G && z[H + 1] !== "none" && z[H + 1]) || z[H]),
                      (st =
                        r && (N === "complete" || N === "reset" || N in r)))),
                  ze &&
                    (G || st) &&
                    (st || k || !r) &&
                    (Te(ze)
                      ? ze(s)
                      : s.getTrailing(ze).forEach(function (Nt) {
                    ...
                    (D && !Ce && !Ir
                      ? (D._dp._time - D._start !== D._time &&
                        ...
                        D.resetTo
                          ...
                          : ((D.vars.totalProgress = A),
                            D.invalidate().restart()))
                      : r && r.totalProgress(A, !!(Ce && (dt || f)))),
                  c)
                ) {
                    ...
                    if (
                      ...
                      if (!f && (ye || We)) {
                        ...
                        Wn(
                          ...
                          F,
                          he.top + (h === ae ? _e : 0) + le,
                          he.left + (h === ae ? 0 : _e) + le
                        );
                      } else Wn(c, ce);
                    lr(ye || We ? Tt : Lt),
                      (vt && A < 1 && ye) || et(Ze + (A === 1 && !We ? _t : 0));
                  }
                }
                T && !Pe.tween && !Ce && !Ir && rt.restart(!0),
                  l &&
                    (G || (ge && A && (A < 1 || !sn))) &&
                    Pr(l.targets).forEach(function (Nt) {
                      return Nt.classList[ye || ge ? "add" : "remove"](
                        l.className
                      );
                    }),
                  u && !ue && !f && u(s),
                  it && !Ce
                    ? (ue &&
                      ...
                      (G || !sn) &&
                        (S && G && Qt(s, S),
                        Me[H] && Qt(s, Me[H]),
                        ge && (A === 1 ? s.kill(!1, 1) : (Me[H] = 0)),
                        G || ((H = A === 1 ? 1 : 3), Me[H] && Qt(s, Me[H]))),
                      ke &&
                        !ye &&
                        Math.abs(s.getVelocity()) > (mr(ke) ? ke : 2500) &&
                        (gr(s.callbackAnimation),
                        D ? D.progress(1) : gr(r, N === "reverse" ? 1 : !A, 1)))
                    : ue && u && !Ce && u(s);
              }
              if (Kt) {
                var be = y ? (w / y.duration()) * (y._caScrollDist || 0) : w;
                Rr(be + (a._isFlipped ? 1 : 0)), Kt(be);
              }
              Jt && Jt((-w / y.duration()) * (y._caScrollDist || 0));
            }
          }),
          (s.enable = function (f, b) {
            s.enabled ||
              ...
              de(x, "resize", xr),
              ie || de(x, "scroll", er),
              oe && de(o, "refreshInit", oe),
              f !== !1 && ((s.progress = me = 0), (De = Re = Ke = ee())),
              b !== !1 && s.refresh());
          }),
          ...
          (s.disable = function (f, b) {
            if (
              ...
              s.enabled &&
                ...
                (nt = 0),
                xe && (xe.uncache = 1),
                oe && pe(o, "refreshInit", oe),
                rt &&
                  (rt.pause(), Pe.tween && Pe.tween.kill() && (Pe.tween = 0)),
                !ie))
            ) {
              for (var _ = E.length; _--; )
                if (E[_].scroller === x && E[_] !== s) return;
              pe(x, "resize", xr), ie || pe(x, "scroll", er);
            }
          }),
          (s.kill = function (f, b) {
          ...
          var L = s.update;
          (s.update = function () {
            (s.update = L), P.cache++, Y || q || s.refresh();
          }),
      ...
      (o.register = function (t) {
        return (
          tr ||
            ((d = t || si()), oi() && window.document && o.enable(), (tr = _r)),
          tr
        );
      }),
      ...
      (o.disable = function (t, r) {
        (_r = 0),
          ...
          pe(I, "touchcancel", ut),
          pe(F, "touchstart", ut),
          Nr(pe, I, "pointerdown,touchstart,mousedown", Ln),
          Nr(pe, I, "pointerup,touchend,mouseup", Fn),
          jr.kill(),
          zr(pe);
        for (var i = 0; i < P.length; i += 3)
          Br(pe, P[i], P[i + 1]), Br(pe, P[i], P[i + 2]);
      }),
      (o.enable = function () {
        if (
          ((M = window),
          ...
          if (
            ...
            (on = d.core.suppressOverwrites || ut),
            (wn = M.history.scrollRestoration || "auto"),
            (xn = M.pageYOffset || 0),
            ...
            (_r = 1),
              ...
              (bn = [M, I, $e, F]),
              d.matchMedia
                ? ((o.matchMedia = function (R) {
                    var k = d.matchMedia(),
                      g;
                    for (g in R) k.add(g, R[g]);
                    return k;
                  }),
            ...
            for (
              u.revert ||
                ...
                l = xt(F),
                ae.m = Math.round(l.top + ae.sc()) || 0,
                Ie.m = Math.round(l.left + Ie.sc()) || 0,
                i
                  ? (r.borderTopStyle = i)
                  : r.removeProperty("border-top-style"),
                t || (F.setAttribute("style", ""), F.removeAttribute("style")),
                Fr = setInterval(Nn, 250),
                d.delayedCall(0.5, function () {
                  return (Ir = 0);
                }),
                de(I, "touchcancel", ut),
                de(F, "touchstart", ut),
                Nr(de, I, "pointerdown,touchstart,mousedown", Ln),
                Nr(de, I, "pointerup,touchend,mouseup", Fn),
                gn = d.utils.checkPrefix("transform"),
                Zr.push(gn),
                tr = Se(),
                jr = d.delayedCall(0.2, Ht).pause(),
                rr = [
                  I,
                  "visibilitychange",
                  function () {
              ...
              Br(pe, P[p], P[p + 1]), Br(pe, P[p], P[p + 2]);
          } else if (I) {
            var S = function R() {
              o.enable(), I.removeEventListener("DOMContentLoaded", R);
            };
      ...
      (o.config = function (t) {
        ...
        (r && clearInterval(Fr)) || ((Fr = r) && setInterval(Nn, r)),
          "ignoreMobileResize" in t &&
            (hn = o.isTouch === 1 && t.ignoreMobileResize),
          "autoRefreshEvents" in t &&
            (zr(pe) || zr(de, t.autoRefreshEvents || "none"),
            (ri = (t.autoRefreshEvents + "").indexOf("resize") === -1));
      }),
      (o.scrollerProxy = function (t, r) {
        var i = Be(t),
          ...
          l = $t(i);
        ~u && P.splice(u, l ? 6 : 2),
          r && (l ? ft.unshift(M, r, F, r, $e, r) : ft.unshift(i, r));
      }),
      ...
      (o.isInViewport = function (t, r, i) {
        var u = (Ue(t) ? Be(t) : t).getBoundingClientRect(),
          l = u[i ? Wt : Gt] * r || 0;
        return i
          ? u.right - l > 0 && u.left + l < M.innerWidth
          : u.bottom - l > 0 && u.top + l < M.innerHeight;
      }),
...
O.refresh = function (o) {
  return o ? xr(!0) : (tr || O.register()) && Ht(!0);
};
O.update = function (o) {
  return ++P.cache && bt(o === !0 ? 2 : 0);
};
O.clearScrollMemory = hi;
O.maxScroll = function (o, e) {
  return ct(o, e ? Ie : ae);
};
O.getScrollFunc = function (o, e) {
  return At(Be(o), e ? Ie : ae);
};
...
O.snapDirectional = En;
O.addEventListener = function (o, e) {
  var n = Vt[o] || (Vt[o] = []);
...
O.batch = function (o, e) {
    ...
    u = function (S, R) {
      var k = [],
        ...
        c = d
          ...
          .pause();
      return function (v) {
        k.length || c.restart(!0),
          k.push(v.trigger),
          g.push(v),
          i <= k.length && c.progress(1);
      };
    },
    l;
  for (l in e)
  ...
  return (
    Te(i) &&
      ((i = i()),
      de(O, "refresh", function () {
        return (i = e.batchMax());
      })),
    Pr(o).forEach(function (p) {
      var S = {};
      for (l in t) S[l] = t[l];
      (S.trigger = p), n.push(O.create(S));
    }),
    n
  );
};
var Un = function (e, n, t, r) {
    ...
    if (!u._isScrollT || l - u._isScrollT > 2e3) {
      for (
        ...
        ((i.scrollHeight <= i.clientHeight && i.scrollWidth <= i.clientWidth) ||
          !(Ur[(p = Qe(i)).overflowY] || Ur[p.overflowX]));
  ...
  mi = function (e, n, t, r) {
    return J.create({
      ...
      onScroll: r,
      onEnable: function () {
        return t && de(I, J.eventTypes[0], Vn, !1, !0);
      },
      onDisable: function () {
        return pe(I, J.eventTypes[0], Vn, !0);
      },
    });
  },
  ...
  Ii = function (e) {
    ...
    var n = e,
      ...
      h = function () {
        (g._gsap.y = vr(parseFloat(g._gsap.y) + c.offset) + "px"),
          (g.style.transform =
    ...
    return (
      ...
      (e.onRelease = e.onGestureStart =
        function (z, Q) {
          if ((c.offset && h(), !Q)) Ee.restart(!0);
            ...
            t &&
              ((s = v()),
              (oe = s + (j * 0.05 * -z.velocityX) / 0.227),
              (j *= Un(v, s, oe, ct(S, Ie))),
              (x.vars.scrollX = y(oe))),
              (s = c()),
              (oe = s + (j * 0.05 * -z.velocityY) / 0.227),
              (j *= Un(c, s, oe, ct(S, ae))),
              (x.vars.scrollY = ke(oe)),
      ...
      (e.onChange = function (z, Q, j, s, oe) {
        if (
          (Ut !== ge && ze(),
          Q && t && v(y(s[2] === Q ? pt + (z.startX - z.x) : v() + Q - s[1])),
          j)
        ) {
          c.offset && h();
          var Yt = oe[2] === j,
            wt = Yt ? ie + z.startY - z.y : c() + j - oe[1],
            Ke = ke(wt);
          Yt && wt !== Ke && (ie += Ke - wt), c(Ke);
        }
        (j || Q) && bt();
      }),
      (e.onEnable = function () {
        cn(S, t ? !1 : "x"),
          O.addEventListener("refresh", Me),
          de(M, "resize", Me),
          c.smooth &&
      ...
      (e.onDisable = function () {
        cn(S, !0),
          pe(M, "resize", Me),
          O.removeEventListener("refresh", Me),
          qe.kill();
      }),
...
O.sort = function (o) {
  if (Te(o)) return E.sort(o);
  var e = M.pageYOffset || 0;
  return (
    O.getAll().forEach(function (n) {
...
O.normalizeScroll = function (o) {
  if (typeof o > "u") return Ye;
  if (o === !0 && Ye) return Ye.enable();
  if (o === !1) {
    Ye && Ye.kill(), (Ye = o);
    return;
  }
  var e = o instanceof J ? o : Ii(o);
  return Ye && Ye.target === e.target && Ye.kill(), $t(e.target) && (Ye = e), e;
};
O.core = {
  _getVelocityProp: dn,
  _inputObserver: mi,
...
si() && d.registerPlugin(O);
export { O as ScrollTrigger, O as default };
