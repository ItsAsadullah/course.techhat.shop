import { w, r as i, _ as C, a as x, c as D } from "./index-3GFABpq9.js";
...
var a = 44,
  ...
  E = i.forwardRef(function (e, g) {
    var r = e.classes,
      b = e.className,
      n = e.color,
      c = n === void 0 ? "primary" : n,
      l = e.disableShrink,
      _ = l === void 0 ? !1 : l,
      d = e.size,
      m = d === void 0 ? 40 : d,
      ...
      y = {},
      p = {};
    if (t === "determinate" || t === "static") {
      var u = 2 * Math.PI * ((a - s) / 2);
      (o.strokeDasharray = u.toFixed(3)),
        (p["aria-valuenow"] = Math.round(k)),
        (o.strokeDashoffset = "".concat(
          (((100 - k) / 100) * u).toFixed(3),
          "px"
        )),
...
const F = w(z, { name: "MuiCircularProgress", flip: !1 })(E);
export { F as C };
