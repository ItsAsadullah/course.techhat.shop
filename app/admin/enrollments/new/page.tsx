      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between rounded-2xl border border-slate-200 bg-white p-3 shadow-sm">
        <form className="relative flex-1 sm:max-w-md">
          ...
          <input
            ...
            className="w-full rounded-xl border border-slate-200 bg-slate-50 py-2.5 pl-9 pr-3 text-sm outline-none transition focus:border-blue-400 focus:bg-white focus:ring-2 focus:ring-blue-400/30"
            autoFocus
          />
      ...
      <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        {students.length === 0 ? (
          <div className="p-16 text-center">
            ...
            <h3 className="mb-1 text-lg font-bold text-slate-900">No students found</h3>
            ...
            {students.map((student) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <span className="hidden sm:inline-flex rounded-full bg-blue-50 px-2.5 py-1 text-xs font-semibold text-blue-600">
                    Assign Course
                  </span>
