...
export const onlineCourses: Course[] = [
  {
    ...
    badge: "জনপ্রিয়",
    badgeColor: "bg-blue-100 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-700",
  ...
  },
  {
    ...
    badge: "সেরা চয়েস",
    badgeColor: "bg-pink-100 dark:bg-pink-900/50 text-pink-700 dark:text-pink-300 border-pink-200 dark:border-pink-700",
  ...
  },
  {
    ...
    badge: "নতুন",
    badgeColor: "bg-cyan-100 dark:bg-cyan-900/50 text-cyan-700 dark:text-cyan-300 border-cyan-200 dark:border-cyan-700",
...
export const offlineCourses: Course[] = [
  ...
  },
  {
    ...
    badge: "নতুন",
    badgeColor: "bg-yellow-100 dark:bg-yellow-900/50 text-yellow-700 dark:text-yellow-300 border-yellow-200 dark:border-yellow-700",
  ...
  },
  {
    ...
    badge: "হট",
    badgeColor: "bg-violet-100 dark:bg-violet-900/50 text-violet-700 dark:text-violet-300 border-violet-200 dark:border-violet-700",
