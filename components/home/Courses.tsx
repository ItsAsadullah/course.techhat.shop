                  ...
                  <div className={`border-t border-slate-100 dark:border-slate-800 pt-4 mt-auto ${isBn ? "font-bn" : ""}`}>
                    ...
                    <div className="flex items-end justify-between">
                      ...
                      <div className="flex gap-2">
                        <Link href={`/courses/${course.slug}`} className={`text-xs font-semibold px-3 py-2 rounded-xl border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all flex items-center shadow-sm`}>
                          {t("course_details")}
                        </Link>
                        <button
                          onClick={() => {
