        ...
        <div className="grid md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-5 flex flex-col gap-6">
            <div className="relative h-[300px] md:h-[400px] rounded-xl overflow-hidden shadow-lg border border-gray-100 dark:border-slate-800">
              <Image src="https://images.unsplash.com/photo-1503676260728-1c00da094a0b?q=80&w=600&auto=format&fit=crop" fill sizes="(max-width: 768px) 100vw, 50vw" alt="Newspaper" className="object-cover" />
            </div>
            <div className="relative h-[250px] md:h-[300px] rounded-xl overflow-hidden shadow-lg border border-gray-100 dark:border-slate-800 bg-white dark:bg-slate-900 p-4">
               ...
               <Image src="https://images.unsplash.com/photo-1504711434969-e33886168f5c?q=80&w=600&auto=format&fit=crop" fill sizes="(max-width: 768px) 100vw, 50vw" alt="News Article" className="object-cover" />
            </div>
          </div>
          ...
          <div className="md:col-span-7 flex flex-col gap-6">
            ...
            <div className="relative h-[300px] md:h-[450px] rounded-xl overflow-hidden shadow-lg border border-gray-100 dark:border-slate-800">
              <Image src="https://images.unsplash.com/photo-1523240795612-9a054b0db644?q=80&w=1000&auto=format&fit=crop" fill sizes="(max-width: 768px) 100vw, 50vw" alt="Students Group Photo" className="object-cover" />
            </div>
            ...
            <div className="grid grid-cols-2 gap-6 h-[200px] md:h-[250px]">
              <div className="relative rounded-xl overflow-hidden shadow-lg border border-gray-100 dark:border-slate-800">
                <Image src="https://images.unsplash.com/photo-1577896851231-70ef18881754?q=80&w=600&auto=format&fit=crop" fill sizes="(max-width: 768px) 100vw, 50vw" alt="Classroom" className="object-cover" />
              </div>
              <div className="relative rounded-xl overflow-hidden shadow-lg border border-gray-100 dark:border-slate-800">
                <Image src="https://images.unsplash.com/photo-1509062522246-3755977927d7?q=80&w=600&auto=format&fit=crop" fill sizes="(max-width: 768px) 100vw, 50vw" alt="Lab" className="object-cover" />
              </div>
            </div>
          </div>
        </div>
