  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 py-2">
      ...
      <div className="space-y-2">
        ...
        {[
          { icon: <Globe className="w-4 h-4" />, label: "GitHub", href: "https://github.com/TechHatBD/typing-master", desc: t("Source code", "সোর্স কোড") },
