...
export default function RegisterForm() {
  ...
  const validate = () => {
    ...
    if (!name.trim()) err.name = "নাম লিখুন"
    ...
    if (!confirmPassword) err.confirmPassword = "পাসওয়ার্ড নিশ্চিত করুন"
    else if (confirmPassword !== password) err.confirmPassword = "পাসওয়ার্ড মিলছে না"
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrors({ general: err.message || "রেজিস্ট্রেশন ব্যর্থ হয়েছে" })
    } finally {
      setLoading(false)
    }
  }
      ...
      <div className="max-w-2xl w-full">
        ...
        >
          <div className="grid md:grid-cols-2">
            ...
            <div className="hidden md:flex flex-col justify-between bg-gradient-to-br from-indigo-600 to-purple-600 p-8 text-white relative overflow-hidden">
              <div className="absolute -top-24 -right-24 w-64 h-64 bg-purple-400/30 rounded-full blur-3xl" />
              <div className="absolute bottom-0 left-0 w-80 h-80 bg-indigo-400/20 rounded-full blur-3xl" />

              <div className="relative z-10">
                <h3 className="text-3xl font-bold mb-2">নতুন অ্যাকাউন্ট!</h3>
                <p className="text-indigo-100 text-sm leading-relaxed">
                  TechHat-এ রেজিস্ট্রেশন করে আপনার প্রফেশনাল শেখার যাত্রা শুরু করুন।
                </p>
              </div>
              ...
              <div className="relative z-10 space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-semibold text-sm">সরাসরি কোর্স অ্যাক্সেস</p>
                    <p className="text-indigo-100 text-xs mt-1">রেজিস্ট্রেশনের পরই কোর্স দেখা শুরু করুন</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-white/20 rounded-xl flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <p className="font-semibold text-sm">সাপোর্ট প্রাপ্য</p>
                    <p className="text-indigo-100 text-xs mt-1">২৪/৭ সাপোর্ট টিমের সাথে কথা বলুন</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="p-8 sm:p-10">
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-slate-900 mb-1">রেজিস্ট্রেশন করুন</h2>
                <p className="text-slate-600 text-sm">আপনার নতুন অ্যাকাউন্ট তৈরি করুন</p>
              </div>
              ...
              {success && (
                <div className="mb-6 flex items-center gap-3 p-4 bg-emerald-50 border border-emerald-200 rounded-xl text-emerald-700 text-sm">
                  ...
                  <span>রেজিস্ট্রেশন সফল! হোম পেজে যাচ্ছেন...</span>
                </div>
              )}

              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  <label className="block text-xs font-semibold text-slate-700 mb-2">পূর্ণ নাম *</label>
                ...
                <div>
                  <label className="block text-xs font-semibold text-slate-700 mb-2">পাসওয়ার্ড নিশ্চিত করুন *</label>
                  <div className="relative">
                    <div className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400">
                      <Lock className="w-5 h-5" />
                    </div>
              ...
              <div className="mt-8 pt-6 border-t border-slate-100 text-center">
                <p className="text-slate-600 text-xs">
                  অ্যাকাউন্ট আছে?{" "}
                  <button onClick={() => router.push("/login")} className="text-indigo-600 font-semibold hover:text-indigo-700 hover:underline transition-colors">
                    লগইন করুন
                  </button>
                </p>
              </div>
