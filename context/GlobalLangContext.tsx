...
export function GlobalLangProvider({ children, initialLang = "bn" }: { children: ReactNode, initialLang?: Lang }) {
  ...
  useEffect(() => {
    ...
    if (stored === "en" || stored === "bn") {
      setLangState(stored);
      document.cookie = `techhat-lang=${stored}; path=/; max-age=31536000`;
    }
  }, []);
  ...
  const setLang = (l: Lang) => {
    ...
    document.cookie = `techhat-lang=${l}; path=/; max-age=31536000`;
    router.refresh();
  };
